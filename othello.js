...
const character002 = {
  ...
  img: function img(x,y,player){
    ban.rows[x].cells[y].removeChild(ban.rows[x].cells[y].firstChild);
    var img = document.createElement("img");
    img.classList.add("piece");
    switch(player){
      case "black":
        img.src = character002.black;
        break;
      case "white":
        img.src = character002.white;
        break;
    }
...
const character003 = {
  ...
    switch(player){
        case "black":
          img.src = character003.black;
          break;
        case "white":
          img.src = character003.white;
          break;
    }
    ban.rows[x].cells[y].appendChild(img);
  }
...
const character004 = {
  ...
    switch(player){
      case "black":
        img.src = character004.black;
        break;
      case "white":
        img.src = character004.white;
        break;
    }
    ban.rows[x].cells[y].appendChild(img);
  }
...
const character005 = {
  ...
    switch(player){
      case "black":
        img.src = character005.black;
        break;
      case "white":
        img.src = character005.white;
        break;
    }
    ban.rows[x].cells[y].appendChild(img);
  }
...
const character006 = {
  ...
    switch(player){
      case "black":
        img.src = character006.black;
        break;
      case "white":
        img.src = character006.white;
        break;
    }
    ban.rows[x].cells[y].appendChild(img);
  }
...
function ban_set(){
  for (var x = 0; x < 6; x++) {
  for (var y = 0; y < 6; y++) {
  while(ban.rows[x].cells[y].firstChild){
    ban.rows[x].cells[y].removeChild(ban.rows[x].cells[y].firstChild);
  }
  ...
  //写真のurlを変更する
  Function('character' + zero + Math.abs(ban_ar[x][y]) +'.img(' + x + "," + y + ',"' + player +'");')();
  break;
  }}}
  return;
  }
